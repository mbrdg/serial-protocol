...
OPTIONS= -D BAUDRATE=B38400 -D TIMEOUT=3 -D MAX_RETRIES=3 -D MAX_PACKET_SIZE=250
DEBUG= -D DEBUG
...
docs:
	pandoc -V lang=pt -V geometry:margin=1in -V fontsize=11pt README.md -o README.pdf
clean:
